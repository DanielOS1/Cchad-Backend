...
export class Migration1712175862965 implements MigrationInterface {
    name = 'Migration1712175862965'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "patient" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "lastName" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "gender" "public"."patient_gender_enum" NOT NULL, "birthdate" TIMESTAMP(0) NOT NULL, "phone" character varying NOT NULL, "address" character varying NOT NULL, "forecast" "public"."patient_forecast_enum" NOT NULL, "enabled" boolean NOT NULL DEFAULT true, "createAt" TIMESTAMP(0) NOT NULL DEFAULT now(), "updateAt" TIMESTAMP(0) NOT NULL DEFAULT now(), CONSTRAINT "UQ_2c56e61f9e1afb07f28882fcebb" UNIQUE ("email"), CONSTRAINT "PK_8dfa510bb29ad31ab2139fbfb99" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."appointment_state_enum" AS ENUM('Aceptado', 'Rechazado', 'Reprogramado', 'Cancelado')`);
        await queryRunner.query(`CREATE TYPE "public"."appointment_type_enum" AS ENUM('consulta', 'control', 'procedimiento')`);
        await queryRunner.query(`CREATE TABLE "appointment" ("id" SERIAL NOT NULL, "startTime" TIMESTAMP(0) NOT NULL, "endTime" TIMESTAMP(0) NOT NULL, "state" "public"."appointment_state_enum" NOT NULL, "confirmed" boolean NOT NULL DEFAULT false, "completed" boolean NOT NULL DEFAULT false, "type" "public"."appointment_type_enum" NOT NULL, "createAt" TIMESTAMP(0) NOT NULL DEFAULT now(), "updateAt" TIMESTAMP(0) NOT NULL DEFAULT now(), "patientId" integer, "shiftId" integer, CONSTRAINT "PK_e8be1a53027415e709ce8a2db74" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."medic_specialty_enum" AS ENUM('Cardiología', 'Dermatología', 'Gastroenterology', 'Neurología', 'Ginecología', 'Obstetricia', 'Oftalmología', 'Psiquiatría', 'Medicina Interna')`);
        ...
        await queryRunner.query(`CREATE TABLE "branch" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "createAt" TIMESTAMP(0) NOT NULL DEFAULT now(), "updateAt" TIMESTAMP(0) NOT NULL DEFAULT now(), CONSTRAINT "PK_2e39f426e2faefdaa93c5961976" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "box" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "createAt" TIMESTAMP(0) NOT NULL DEFAULT now(), "updateAt" TIMESTAMP(0) NOT NULL DEFAULT now(), "branchId" integer, CONSTRAINT "PK_1a95bae3d12a9f21be6502e8a8b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "shift" ("id" SERIAL NOT NULL, "startTime" TIMESTAMP(0) NOT NULL, "endTime" TIMESTAMP(0) NOT NULL, "blocked" boolean NOT NULL DEFAULT false, "createAt" TIMESTAMP(0) NOT NULL DEFAULT now(), "updateAt" TIMESTAMP(0) NOT NULL DEFAULT now(), "medicId" integer, "boxId" integer, CONSTRAINT "PK_53071a6485a1e9dc75ec3db54b9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "secretary" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "lastName" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "createAt" TIMESTAMP(0) NOT NULL DEFAULT now(), "updateAt" TIMESTAMP(0) NOT NULL DEFAULT now(), CONSTRAINT "UQ_dfad141abd9ea263d0e03a9bb98" UNIQUE ("email"), CONSTRAINT "PK_e6c85e70fd48750bbd8e34a553c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "admin" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "lastName" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "createAt" TIMESTAMP(0) NOT NULL DEFAULT now(), "updateAt" TIMESTAMP(0) NOT NULL DEFAULT now(), CONSTRAINT "UQ_de87485f6489f5d0995f5841952" UNIQUE ("email"), CONSTRAINT "PK_e032310bcef831fb83101899b10" PRIMARY KEY ("id"))`);
